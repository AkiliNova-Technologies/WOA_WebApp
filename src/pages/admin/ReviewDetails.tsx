                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <p className="font-medium">{reviewData.buyerEmail}</p>
                        </div>
                      </div>
                      <div>
                        <Label className="text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <p className="font-medium">{reviewData.buyerPhone}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
