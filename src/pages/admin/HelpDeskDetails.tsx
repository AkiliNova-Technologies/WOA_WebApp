    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px]">
        ...
        <div className="space-y-4 py-4">
          ...
          {/* Note Textarea (shows when status is changed) */}
...
export default function AdminHelpDeskCaseDetailPage() {
  ...
  const caseData: HelpDeskCaseDetail = {
    id: caseId || "1",
    ...
    descriptionDetails: [
      "For sellers who might be suspended or have questions about the terms of service.",
    ],
            ...
            <div className="relative mx-6 space-y-6 z-10">
              ...
              <Card className="-mt-24">
                <div className="bg-white rounded-2xl p-8  w-full">
                  <h1 className="text-3xl font-bold mb-2">{caseData.caseId}</h1>
                  <p className="text-lg mb-6">
                    Reported on: {caseData.reportedOn}
                  </p>
                    ...
                    <CardContent className="p-8">
                      ...
                      <div className="space-y-6">
                        ...
                        <div>
                          ...
                          {caseData.descriptionDetails &&
                            caseData.descriptionDetails.length > 0 && (
                              <ul className="list-disc list-inside space-y-1">
                                {caseData.descriptionDetails.map(
                                  (detail, index) => (
                                    <li
                                      key={index}
