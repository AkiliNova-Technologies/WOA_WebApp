    ...
    <div className="min-h-screen">
      ...
      <div className="relative w-full h-[360px] overflow-hidden rounded-2xl">
        ...
        <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center gap-3">
          ...
          <p className="text-white/80 text-sm">Optimal dimension 1100×400 px</p>
      ...
      {/* ================= STORE SUMMARY ================= */}
      <Card className=" relative max-w-6xl mx-auto  -mt-12 shadow-xs border bg-white">
      ...
      {/* ================= STORE DESCRIPTION ================= */}
      <Card className="max-w-6xl mx-auto mt-8 shadow-xs border bg-white">
        <CardContent className="p-6">
          ...
          <div className="border rounded-sm p-3">
            <p className="text-sm text-[#3A3A3A] leading-relaxed">
              ...
              accessories. With over 5 years of experience in local retail, she
              brings a vibrant mix of tradition and modern style to her
          ...
          <h2 className="text-lg font-semibold mt-8 mb-4">Seller Story</h2>
